...
class BD(object):
    ...
    def setDataFases(fase,actions,ficha,time):
        ...
        Tempo para a primeira rea��o:'''+ str(finalTime1[2]) + str(finalTime1[1]) + str(finalTime1[0]) + '''
        Tempo para a primeira rea��o:'''+ str(finalTime2[2]) + str(finalTime2[1]) + str(finalTime2[0]) 
    ...
    def send():
        if BD.testConnection():
            ...
            print 'Falha ao enviar o email!Não há conexão com a internet!'
            pass
